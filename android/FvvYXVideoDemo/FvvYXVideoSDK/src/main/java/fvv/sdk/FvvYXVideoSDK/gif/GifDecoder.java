...
public class GifDecoder extends Thread
{
	...
	private GifDecoderAction action = null;


	private byte[] gifData = null;


	public GifDecoder(byte[] data, GifDecoderAction act)
	{
		gifData = data;
		action = act;
	}

	public GifDecoder(InputStream is, GifDecoderAction act)
	{
		in = is;
		action = act;
	}
